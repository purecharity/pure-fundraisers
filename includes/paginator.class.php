...
class Purecharity_Wp_Fundraisers_Paginator {
  ...
  public static function page_links($meta = array(), $options = array()) {
    ...
    if ($meta->current_page > 1) {
      $html .= '<li><a class="page-numbers" href="?_page='.($meta->current_page-1).$query_param.'">Previous</a></li>';
    }
    ...
    if ($meta->num_pages < 10) {
      for ($i = 1; $i <= $meta->num_pages; $i++) {
        if ($meta->current_page == $i) {
          ...
          $html .= '<li><a class="page-numbers" href="?_page='.$i.$query_param.'">'.$i.'</a></li>';
        }
      }
    } else {
    ...
    if ($meta->current_page < $meta->num_pages) {
      $html .= '<li><a class="page-numbers" href="?_page='.($meta->current_page+1).$query_param.'">Next</a></li>';
    }
  ...
  /**
   * Retrieve the query parameter from the HTTP GET request used for pagination
   *
   * @since    1.2.2
   */
  public static function get_query_param($value_only=false) {
